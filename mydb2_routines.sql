...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Consulta`(diaMaquina VARCHAR(45))
BEGIN
	SELECT statusMaq,hora FROM cnc WHERE data=diaMaquina; 
END ;;
DELIMITER ;
...
-- Dump completed on 2024-06-17 19:41:29
